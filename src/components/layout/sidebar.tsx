...
function SidebarContent({ openSections, activeHref, toggleSection, onNavigate }: SidebarContentProps) {
  return (
    <div className="flex flex-col h-full" style={{ fontFamily: "'DM Mono', monospace" }}>
      <a
        href="#hero"
        onClick={(e) => { e.preventDefault(); scrollTo('#hero'); onNavigate(); }}
          ...
          return (
            <div key={item.label}>
              {hasChildren ? (
                ...
                <a
                  href={item.href}
                  onClick={(e) => { e.preventDefault(); scrollTo(item.href!); onNavigate(); }}
                ...
                {item.children?.map((child) => {
                  ...
                  return (
                    <a
                      key={child.href}
                      href={child.href}
                      onClick={(e) => { e.preventDefault(); scrollTo(child.href); onNavigate(); }}
